        ...
        <div class="container">
            <div class="product-container">
                ...
                <div class="product-gallery">
                    <div class="main-image" onclick="openZoom('<?php echo $product['main_image'] ? 'uploads/products/' . $product['main_image'] : 'https://via.placeholder.com/500x500/f3f4f6/9ca3af?text=No+Image'; ?>')">
