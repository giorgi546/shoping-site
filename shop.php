                            ...
                            <div class="product-card">
                                <div class="product-image-container">
                                    <img src="<?php echo $item['main_image'] ? 'uploads/products/' . $item['main_image'] : 'images/placeholder.jpg'; ?>" 
                                         ...
                                         onerror="this.src='https://via.placeholder.com/300x250/f3f4f6/9ca3af?text=No+Image'">
                    ...
                    <div class="modal-content" style="background: white; border-radius: 16px; max-width: 800px; width: 90%; max-height: 90%; overflow-y: auto;">
                        ...
                        <div class="modal-body" style="padding: 2rem; display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                            <div class="product-image">
                                <img src="${product.main_image ? 'uploads/products/' + product.main_image : 'https://via.placeholder.com/400x300/f3f4f6/9ca3af?text=No+Image'}" 
                                     alt="${product.name}" 
